...
class DetailPengeluaranActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (transaksiId != -1) {
            lifecycleScope.launch {
                ...
                if (transaksi != null) {
                    ...
                    findViewById<TextView>(R.id.tvDetailJumlahPe).text = "Rp ${formatter.format(jumlahBersih)}"
                    findViewById<TextView>(R.id.tvDetailTanggalPe).text = transaksi.tanggal
                    findViewById<TextView>(R.id.tvDetailKeteranganPe).text =
                    ...
                    if (!transaksi.buktiFoto.isNullOrEmpty()) {
                        try {
                            ...
                            ivBukti.setOnClickListener {
                                showFullScreenImage(this@DetailPengeluaranActivity, transaksi.buktiFoto)
                            }
                        } catch (e: Exception) {
        ...
        findViewById<androidx.appcompat.widget.AppCompatButton>(R.id.btnSelesaiDetailPe).setOnClickListener {
            finish()
        }

        findViewById<androidx.appcompat.widget.AppCompatButton>(R.id.btnEditDetailPe).setOnClickListener {
            val intent = android.content.Intent(this@DetailPengeluaranActivity, TambahPengeluaranActivity::class.java)
        ...
        findViewById<androidx.appcompat.widget.AppCompatButton>(R.id.btnHapusDetailPe).setOnClickListener {
            konfirmasiHapus()
        }
